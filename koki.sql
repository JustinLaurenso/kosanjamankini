...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Apr 2019 pada 14.30
...
CREATE TABLE `tbkos` (
  `kode_kos` varchar(20) NOT NULL,
  `gmbr_kos` varchar(100) DEFAULT NULL,
...
('justin123', 'Justin', 'justin.laurenso@gmail.com', '$2y$10$Ci0CDF6IlVy2BM6gHjN01uLSePvitV5sn8YG96Ehkjez5/nZS/YCS'),
...
('Justin', 'Male', '2019-04-16', 'justin123', 'justin.laurenso@gmail.com', 'Surabaya, Jawa Timur'),
