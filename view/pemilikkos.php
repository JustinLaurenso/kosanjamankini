...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="../assets/css/pemilikkos.css">
    ...
    <div class="col-lg-12">
      <div class="form col-lg-5">
        <form >
          ...
          <div class="form-group">
            <label for="ket">Daftar Sebagai :</label>
            <select class="form-control" id="role" name="role">
              <option>Pemilik</option>
              <option>Pencari</option>
            </select>
          </div>
          <p style="text-align: center;font-size: 12px;">Dengan ini <b>Anda menyetujui</b> Ketentuan, Kebijakan Data dan Kebijakan Cookie kami</p>
          <div align="middle">
