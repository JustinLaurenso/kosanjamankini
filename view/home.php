				 ...
				 <div class="navbar">
                        <ul class="nav">
                           ...
                           <li>
                            ...
                            <li>
                            	<div style="background: red; width: 20px; text-align: center; color: #fff; border-radius: 50%; position: absolute; margin-left: 73px;margin-top: -10px; z-index: -1">3</div>
                               <div class="dropdown">
                               ...
                               <div class="dropdown-menu biasa" style="background: white; color: #000;">
                               		...
                               		<div class="pesanan-content">
                               			<div class="row" data-toggle="modal" data-target="#detail-pesanan">
                               				<div class="col-md-8">Nasi Uduk</div>
                               				<div class="col-md-4">Rp 20.000</div>
                               			</div>

                               			<div class="row">
                               				<div class="col-md-8">Ayam Bakar</div>
                               				<div class="col-md-4">Rp 15.000</div>
                               			</div>

                               			<div class="row">
                               				<div class="col-md-8">Martabak Manis</div>
                               				<div class="col-md-4">Rp 18.000</div>
                               			</div>
                               		</div>
                               </div>
                           		</div>
                            ...
                            <div class="modal fade" id="detail-pesanan" style="margin-top: 40px;">
                            	<div class="modal-dialog">
                            		<div class="modal-content">
                            			...
                            			<div class="modal-body">
                            				<div class="row">
                            					<div class="col-md-12">
                            						<img src="../assets/img/dinner2.jpg" width="100%" alt="">
                            					</div>
                            				</div>
                            				<div class="row">
                            				...
                            				<div class="row">
                            					<div class="col-md-4">Nama Tempat Makan</div>
                            					<div class="col-md-1"> : </div>
                            					<div class="col-md-7"> Nasi Uduk Borobudur </div>
                            				</div>
                            				<div class="row">
                            					<div class="col-md-4">Jumlah Pesanan</div>
                            					<div class="col-md-1"> : </div>
                            				...
                            				<div class="row">
                            					...
                            					<div class="col-md-1"> : </div>
                            					<div class="col-md-7">Rp 20.000</div>
                            				</div>
                            				<div class="row">
                            				...
                            				<div class="row" style="margin-top: 20px;">
                            					...
                            					<div class="col-md-6">
                            						<button class="btn btn-success selesai" style="width: 100%;" disabled>
                            							Selesai
                            						</button>
                            					</div>
                            					<div class="col-md-3"></div>
