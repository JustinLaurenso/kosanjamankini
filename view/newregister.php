          ...
          <div class="register">
            ...
            <div class="row row1">
             ...
             <div class="row row1">
              ...
              <div class="col-lg-10 col-sm-10">
                <input type="text" class="form-control" name="e-mail" id="e-mail" placeholder="E-mail">
              </div>
            </div>
            ...
            <div class="row row1">
             ...
             <div class="row row1">
              ...
              <div class="col-lg-10 col-sm-10">
                <input type="text" class="form-control" name="repassword" id="password" placeholder="Re-Type Password">
              </div>
            </div>
            ...
            <div class="row row2">
              ...
              <div class="tombol_masuk col-lg-4 col-sm-4">
                <a href="home.html"><input type="submit" name="login" id="login" value="Daftar" class="btnmasuk"></a>
              </div>
              <div class="col-lg-4 col-sm-4"></div>
            </div>
